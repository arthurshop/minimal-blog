...
tags:
  - Python
  - Data
banner: ./columns-name-python.jpg
---
...
<p align="center">
  <img src="./columns-name-python.jpg" alt="Display Columns - Arthur Camberlein" title="How to display columns dataframe" />
</p>
...
There is an easier an quicker way you could use to display your columns name as a list: `df.columns`; you said simpler than that? No, sorry I can't! 😆

```python
df.columns
```

Why did I presented you this whole process and article if it's simply `df.columns`? Because with this article you learned "the hard way" and even if it's as simple as `df.columns`, now you will be able to understand other piece of code or adapt 😉