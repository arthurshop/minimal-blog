...
Do you know what `brew` (Homebrew) is? If the answer is no & that you are using MacOS and your Terminal ... how are you doing you automation work? 😉
...
<p align="center">
  <img src="./search-homebrew-search-website.png" alt="Search on the Homebrew website for Spotify - Arthur Camberlein" title="Search on the website for Spotify" />
</p>
...
1. The first reason is that it is a very popular ebook reader and manager, and it is available for free.
2. The second reason is that homebrew is a package manager for mac, and it makes it easy to install and update software. And as this article state, I strongly recommend you to use it!
3. Finally, the third reason is that installing Calibre with homebrew is very easy & leave no trace.
...
You can for sure install some other software like `google-chrome`, `firefox`, ...
